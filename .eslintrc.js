module.exports = {
	...
	overrides: [
		...
		},
		{
			...
			rules: {
				// False positive on a URL value: this rule would "camelCase" the
				// documentationUrl and break it, conflicting with the *-not-http-url rule
				// which (correctly) wants a real HTTPS URL.
